...
train_dataset = OwlSoundWaveformDataset(train_df, AUDIO_DIR, channels=1)
val_dataset = OwlSoundWaveformDataset(val_df, AUDIO_DIR, channels=1)
...
# --- Load metadata and dataset ---
    ...
    # Save model
    torch.save(model.state_dict(), "buow_tinycnn_leaf.pth")
    print("Saved model to buow_tinycnn_leaf.pth")
